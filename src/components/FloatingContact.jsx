  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="group relative flex items-center justify-center w-23 h-23 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg hover:shadow-emerald-600/50 transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
      ...
      <a
        ...
        className="group relative flex items-center justify-center w-23 h-23 rounded-full bg-brandRed-600 hover:bg-brandRed-500 text-white shadow-lg hover:shadow-glow-red transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brandRed-500"
