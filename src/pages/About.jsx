...
export default function About() {
  ...
  return (
    <div className="bg-slate-50">
      {/* Top Banner */}
      <PageBanner
        desktopImage="/images/section_banners/banner-aboutus.png"
        mobileImage="/images/section_banners/banner-aboutus-mobile.png"
        alt="About Deccan Toolings - Driven by Precision, Built on Experience"
